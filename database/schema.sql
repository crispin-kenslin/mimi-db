...
(
    ...
    'Poaceae',
    "Finger millet (Eleusine coracana (L.) Gaertn) is widely cultivated in Africa and South Asia and ranks fourth important in millets.  The crop was domesticated around 5000 years BC. It is rich in calcium, dietary fibre, phytates, proteins, minerals, and phenolics. Moreover, it is also a rich source of thiamine, riboflavin, iron, methionine, isoleucine, leucine, phenylalanine and other essential amino acids. The global cultivation spans about 4 to 4.5 million hectares, in which India is the world's largest producer. ",
...
(
    ...
    'Poaceae',
    'Foxtail millet (Setaria italica) originated from China and now cultivated worldwide. The crop was domesticated 10,000 years ago. It is an important staple food that is widely cultivated in semi-arid regions of Asia, Eurasia, and Africa. It is a model organism for C4 plants. Foxtail millet ranks second important among the millets. It is recognized as diabetic food as it is rich in dietary fibre, minerals, proteins and has low glycemic index (GI).',
